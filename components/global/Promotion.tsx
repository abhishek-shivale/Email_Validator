...
function Promotion() {
  return (
    ...
    <h2 className={`${rubikMonoOne.className} text-4xl font-bold text-center mb-6`}>Join Our Launch!</h2>
    <p className={`${poppins.className} antialiased text-center text-sm mb-8`}>
      Were excited to announce the launch of our new bulk email validation feature!
    </p>
